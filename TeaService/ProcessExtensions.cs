...
namespace TeaService
{
    public class UserLogins
    {
        ...
        static extern bool WTSQuerySessionInformation(
            System.IntPtr hServer, uint sessionId, WTS_INFO_CLASS wtsInfoClass, out System.IntPtr ppBuffer, out uint pBytesReturned);

        [DllImport("kernel32.dll")]
        private static extern uint WTSGetActiveConsoleSessionId();

        [DllImport("Wtsapi32.dll")]
        private static extern int WTSQueryUserToken(uint SessionId, ref IntPtr phToken);
        ...
        private static bool GetSessionUserToken(ref IntPtr phUserToken, uint sessid)
        {
            var bResult = false;
        ...
        public static bool StartProcessAsUser(string user, string appPath, string cmdLine = null, string workDir = null, bool visible = true)
        {
            ...
            UserInfo userdata = GetUser(".", user);

            try
            {
                if (!GetSessionUserToken(ref hUserToken, userdata.SessionID))
                {
